...
include </usr/local/lib/python3.11/dist-packages/solid2/extensions/bosl2/BOSL2/metric_screws.scad>;
include </usr/local/lib/python3.11/dist-packages/solid2/extensions/bosl2/BOSL2/turtle3d.scad>;

cylinder(h = 55, r1 = 5, r2 = 2);
